...
ll dfs(pll vertex)
{
    ...
    */
    ...
    if (vertex.first == n - 1 && vertex.second == m - 1)
        return 1;

    if (dp[vertex.first][vertex.second] != -1)
        return dp[vertex.first][vertex.second];
    ...
    */
    return dp[vertex.first][vertex.second] = ret;
}
int main()
{
    fast;
